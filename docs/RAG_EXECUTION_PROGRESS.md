...
> 阶段交付三元组见 §3 的 `[B8-1]` / `[B8-2]` / `[B8-3]` / `[T-7.3 / T-7.4]`。
>
...
| 想干什么 | 看哪份 |
| --- | --- |
| 接手继续做 | `docs/RAG_NEXT_WINDOW_PROMPT.md`（**已重写为混合检索后的交接版**） |
...
| 「做过什么、踩过什么」 | 本文件 §3 + `docs/RAG_DEV_PITFALLS.md`（**84 条**：A11 / B21 / C8 / D27 / E11 / F6） |
